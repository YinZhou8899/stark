...
def content(self):
    ...
    # 过滤
    queryset = self.model.objects.filter(filter_conditions).order_by(*self.get_order_by())
    ...
    def body_list():
        for row in queryset:
            ...
            for name in list_display:
                ...
                row_list.append(val)
            yield row_list
    return {'header_list': header_list(), 'body_list': body_list(),"action_list":action_list,"page":page}
